...
root_password = node["rubyserver"]["db_root_password"]
if root_password
  Chef::Log.info %(Set node["postgresql"]["password"]["postgres"] attributes to node["rubyserver"]["db_root_password"])
...
#node["rubyserver"]["databases"]["postgresql"].each do |entry|
#
